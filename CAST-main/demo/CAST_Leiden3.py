...
output_path = Path("/p2/zulab/jtian/data/SA/06_calculateConcentration/output_CAST_Leiden3/")
...
###########################CAST.MARK##########################################
adata = ad.read_h5ad("/p2/zulab/jtian/data/SA/06_calculateConcentration/output_CAST_Leiden2/adata30.h5ad")                #########################
...
exp_dict = {sample_t: adata[adata.obs['sample'] == sample_t].layers['norm_1e4_log1p_scale'] for sample_t in samples}
args = Args(
            dataname='task1', # name of the dataset, used to save the log file
            gpu = 0, # gpu id, set to zero for single-GPU nodes
            epochs=500,#400   # number of epochs for training
