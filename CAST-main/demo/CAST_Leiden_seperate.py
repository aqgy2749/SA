...
output_path = Path("/p2/zulab/jtian/data/SA/06_calculateConcentration/output_CAST_Leiden_seperate/")
...
###########################CAST.MARK##########################################
cast_output_root = Path("/p2/zulab/jtian/data/SA/06_calculateConcentration/output_CAST_Leiden1/CAST_MARK_by_sample/")
