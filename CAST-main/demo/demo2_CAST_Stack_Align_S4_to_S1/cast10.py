...
output_path = f'{work_dir}/output_cast10'      ############
...
#     print(adata.X[:5])
#     print(np.min(adata.X), np.max(adata.X))
#     OUTPUT_H5AD = f'{output_path}/demo1_cast9.h5ad'                    ########################
#     adata.write_h5ad(OUTPUT_H5AD)
#     print(f"\n✅ 成功保存 AnnData 文件到 {OUTPUT_H5AD}")

###########################CAST.MARK##########################################
adata = ad.read_h5ad(f'{output_path}/demo1_cast9.h5ad')                #########################
...
embed_dict = torch.load(f'{output_path}/demo_embed_dict.pt',map_location='cpu')#来自cast9
###########################CAST.STACK##########################################
graph_list = ['15','0']
