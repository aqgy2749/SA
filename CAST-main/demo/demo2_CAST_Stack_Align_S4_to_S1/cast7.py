...
output_path = f'{work_dir}/output_cast7'      ############
...
coords_final = CAST.CAST_STACK(coords_raw, embed_dict, output_path, graph_list,mid_visual=True,params_dist=params_dist,load_affine_ckpt=False,save_affine_ckpt=True,affine_ckpt_path=None)
# coords_final = CAST.CAST_STACK(coords_raw, embed_dict, output_path, graph_list,mid_visual=True,params_dist=params_dist,load_affine_ckpt=True,save_affine_ckpt=False,affine_ckpt_path=None,strict_affine_ckpt_match=True)
