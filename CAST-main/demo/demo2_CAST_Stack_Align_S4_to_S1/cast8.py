...
output_path = f'{work_dir}/output_all'
os.makedirs(output_path, exist_ok=True)
adata = ad.read_h5ad(f'{output_path}/demo1_10CPMLogScale.h5ad')
...
embed_dict = torch.load(f'{output_path}/demo_embed_dict.pt',map_location='cpu')#来自ccast_markStackAll2.py
graph_list = ['30','15'] # [query_sample, reference_sample]
