...
output_path = f'{work_dir}/output_10LogScaleF'
...
#     print(adata.X[:5])
#     print(np.min(adata.X), np.max(adata.X))
#     OUTPUT_H5AD = f'{output_path}/demo1_10LogScaleF.h5ad'
#     adata.write_h5ad(OUTPUT_H5AD)
#     print(f"\n✅ 成功保存 AnnData 文件到 {OUTPUT_H5AD}")

###########################CAST.MARK##########################################
adata = ad.read_h5ad(f'{output_path}/demo1_10LogScaleF.h5ad')
...
args = Args(
            ...
            epochs=600,#400   # number of epochs for training
