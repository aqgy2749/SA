...
shift = coords_raw['0'].mean(axis=0) - coords_raw['15'].mean(axis=0)
coords_raw['15'] = coords_raw['15'] + shift
shift = coords_raw['0'].mean(axis=0) - coords_raw['30'].mean(axis=0)
coords_raw['30'] = coords_raw['30'] + shift
shift = coords_raw['0'].mean(axis=0) - coords_raw['45'].mean(axis=0)
coords_raw['45'] = coords_raw['45'] + shift
shift = coords_raw['0'].mean(axis=0) - coords_raw['60'].mean(axis=0)
coords_raw['60'] = coords_raw['60'] + shift
