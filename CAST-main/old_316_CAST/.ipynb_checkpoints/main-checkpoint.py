...
def CAST_STACK(coords_raw,embed_dict,output_path,graph_list,params_dist= None,tmp1_f1_idx = None, mid_visual = False, sub_node_idxs = None, rescale = False, corr_q_r = None, if_embed_sub = False, early_stop_thres = None, renew_mesh_trans = True):
    ...
    # plot_mid(coords_final[query_sample],output_path,f'{prefix_t}_align_q')
    # plot_mid(coords_final[ref_sample],output_path,f'{prefix_t}_align_r')
    plot_single(coords_final[ref_sample], output_path, f'{prefix_t}_ref')
    plot_single(coords_final[query_sample], output_path, f'{prefix_t}_query')
